...
```{r}
CD81_donor1_rep2 <- read_cov_file_for_DSS("exp_1/methylation_coverage/CD81_DONOR1_REP2_1_val_1_bismark_bt2_pe.deduplicated.bismark.cov.gz")
...
```{r}
saveRDS(combined_BSobj, 'combined_BSobj_exp1.rds')
```
...
# Design matrix
design <- model.matrix(~ 0 + donor + replicate + treatment)
