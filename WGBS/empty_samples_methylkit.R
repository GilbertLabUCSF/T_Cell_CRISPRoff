...
g_manhattan <- ggplot(filteredDiffMethDataFrame, aes(x = start, y = neg_log10_pval, color = as.factor(chr))) +
...
#ggsave(g_manhattan, 'results/exp3_EMPTY.png')
...
ggsave(g, 'results/sample_methylation_empty_electroporation.png')
ggsave(g_manhattan, 'results/exp3_EMPTY.png')