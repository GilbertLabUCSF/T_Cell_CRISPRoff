...
# List of file paths
file_paths <- list(
  "exp_3/methylation_coverage/CD55DONOR3_REP1_1_val_1_bismark_bt2_pe.deduplicated.bismark.cov.gz",
  "exp_3/methylation_coverage/CD55DONOR3_REP2_1_val_1_bismark_bt2_pe.deduplicated.bismark.cov.gz",
  ...
  "exp_3/methylation_coverage/CD55DONOR4_REP1_1_val_1_bismark_bt2_pe.deduplicated.bismark.cov.gz",
  "exp_3/methylation_coverage/CD55DONOR4_REP2_1_val_1_bismark_bt2_pe.deduplicated.bismark.cov.gz",
...
sample_names <- c("CD55_donor3_rep1", "CD55_donor3_rep2", "control_donor3_rep1", "control_donor3_rep2",
                  "CD55_donor4_rep1", "CD55_donor4_rep2", "control_donor4_rep1", "control_donor4_rep2")
...
filteredDiffMethDataFrame %>% arrange(qvalue) %>% write_csv('results/CD55_methylkit_1000_100.csv')
#ggsave(g, 'results/exp3_CD55.png')



#### Make the sample level plots
...
#CD55
specific_chr <- "chr1"
specific_start <- 207321678 - 5000  
specific_end <- 207360966 + 5000    
...
# Plot as barplots
ggplot(longData, aes(x = start, y = methylation, fill = color)) +
  geom_col() +
  scale_fill_identity() +
...
ggsave('results/sample_methylation_CD55.png')
