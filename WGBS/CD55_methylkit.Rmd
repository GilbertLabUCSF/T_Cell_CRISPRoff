...
tiledObj <- tileMethylCounts(methylationBaseObj, tile.size = 1000, step.size = 1000, mc.cores=32)
...
ggsave(g, 'results/exp3_CD55.png', width = 14, height=7, units = 'cm')
```
...
ggsave('results/sample_methylation_CD55.png', width = 14, height=7, units = 'cm')
```
